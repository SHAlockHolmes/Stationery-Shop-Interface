...
<section class="container grey-text">
    ...
    <form class="white" action="updateMA.php" method="POST">

        <label>First Name:</label>
        <input type="text" name="fname" value="<?php echo htmlspecialchars($row[1])?>">
        <div class="red-text"><?php echo $errors['fname'] ?></div>

        <label>Last Name:</label>
        <input type="text" name="lname" value="<?php echo htmlspecialchars($row[2])?>">
        <div class="red-text"><?php echo $errors['lname'] ?></div>
        
        <label>Phone Number:</label>
        <input type="text" name="phno" value="<?php echo htmlspecialchars($row[3])?>">
        <div class="red-text"><?php echo $errors['phno'] ?></div>
        
        <label>Address Line 1:</label> 
        <input type="text" name="ad1" value="<?php echo htmlspecialchars($row[4])?>">
        <div class="red-text"><?php echo $errors['ad1'] ?></div>
        
        <label>Address Line 2</label> 
        <input type="text" name="ad2" value="<?php echo htmlspecialchars($row[5])?>">
        <div class="red-text"><?php echo $errors['ad2'] ?></div>

        <label>Street</label> 
        <input type="text" name="street" value="<?php echo htmlspecialchars($row[6])?>">
        <div class="red-text"><?php echo $errors['street'] ?></div>

        <label>Pincode</label> 
        <input type="text" name="pcode" value="<?php echo htmlspecialchars($row[12])?>">
        <div class="red-text"><?php echo $errors['pcode'] ?></div>

        <label>City</label> 
        <input type="text" name="city" value="<?php echo htmlspecialchars($row[13])?>">
        <div class="red-text"><?php echo $errors['city'] ?></div>

        <label>State</label>
        <input type="text" name="state" value="<?php echo htmlspecialchars($row[14])?>">
        <div class="red-text"><?php echo $errors['state'] ?></div>

        <label>Country</label>
        <input type="text" name="country" value="<?php echo htmlspecialchars($row[15])?>">
